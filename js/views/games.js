...
<div class="h-[92vh] w-full bg-[#020408] flex flex-col overflow-hidden animate-in fade-in duration-500">
    <header class="p-6 border-b border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#050b1d]/50 backdrop-blur-md">
        ...
        <div class="flex items-center gap-2 p-1 bg-white/[0.02] border border-white/5 rounded-2xl">
            <button onclick="switchGameMode('puzzle')" class="mode-btn px-4 py-2 bg-blue-600 rounded-xl text-[8px] font-black text-white uppercase tracking-widest transition-all shadow-lg shadow-blue-600/20">
                Puzzle
            </button>
            <button onclick="switchGameMode('quiz')" class="mode-btn px-4 py-2 hover:bg-white/5 rounded-xl text-[8px] font-black text-white/40 uppercase tracking-widest transition-all hover:text-white">
                Syntax Quiz
            </button>
            <button onclick="switchGameMode('typing')" class="mode-btn px-4 py-2 hover:bg-white/5 rounded-xl text-[8px] font-black text-white/40 uppercase tracking-widest transition-all hover:text-white">
                Velocity
            </button>
        </div>
    ...
    <main class="flex-1 flex flex-col items-center justify-center p-6 space-y-8 overflow-y-auto">
        ...
        <div class="flex flex-col items-center gap-4">
            <div class="flex items-center gap-3 px-6 py-3 bg-white/[0.02] border border-white/5 rounded-full shadow-inner">
                <i class="fas fa-microchip text-[10px] text-blue-500 animate-pulse"></i>
                <p id="systemMessage" class="text-[9px] font-bold text-white/40 uppercase tracking-[0.2em]">INITIALIZING NEURAL LINK...</p>
            </div>
    ...
    <div id="gameOverlay" class="hidden fixed inset-0 z-[200] flex items-center justify-center bg-black/95 backdrop-blur-md p-4 animate-in fade-in duration-300">
    </div>
</div>
`;
