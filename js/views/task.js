...
views['Task'] = `
    ...
    <div id="createTaskModal" class="fixed inset-0 z-[110] hidden flex items-center justify-center p-6">
        ...
        <div class="relative bg-[#0F0F0F] border border-blue-500/20 w-full max-w-lg rounded-[3.5rem] p-12 shadow-[0_0_50px_rgba(37,99,235,0.1)] animate-in slide-in-from-bottom-10 duration-500">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" placeholder="ENTER TASK NAME..." class="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white text-sm focus:outline-none focus:border-blue-500/50 transition-all">
                </div>
                <div>
                    <label class="text-white/30 text-[9px] font-black uppercase tracking-widest ml-4 mb-2 block">Priority Level</label>
                    <div class="grid grid-cols-3 gap-3">
                        <button class="py-3 rounded-xl bg-white/5 border border-white/5 text-white/40 text-[9px] font-black uppercase hover:border-blue-500/50 transition-all">Low</button>
                        <button class="py-3 rounded-xl bg-blue-600 text-white text-[9px] font-black uppercase">Medium</button>
                        <button class="py-3 rounded-xl bg-white/5 border border-white/5 text-white/40 text-[9px] font-black uppercase hover:border-blue-500/50 transition-all">High</button>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-4 mt-10">
                ...
                <button class="flex-2 px-10 py-4 rounded-2xl bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 shadow-lg shadow-blue-600/20 transition-all">Initialize</button>
            </div>
        </div>
    </div>
`;
