...
views['Task'] = `
    <div class="max-w-7xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <!-- Task Limit Card (Blue Highlight) -->
            ...
            <div class="bg-[#1A1A1A] border border-white/5 rounded-[2.5rem] p-8 flex flex-col justify-between h-48 relative group cursor-pointer hover:bg-[#222] transition-all">
                <div class="flex justify-between items-start">
                    ...
                    <button onclick="openTaskModal('Pending Tasks')" class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white group-hover:bg-blue-600 group-hover:border-blue-600 transition-all">
                        <i class="fas fa-arrow-up rotate-45 text-sm"></i>
                    </button>
                </div>
            ...
            <div class="lg:col-span-4 bg-[#1A1A1A] rounded-[2.5rem] p-8 border border-white/5">
                ...
                <div class="mt-10">
                    ...
                    <div class="flex items-center gap-3">
                         <div class="w-10 h-10 rounded-full border-2 border-dashed border-white/10 flex items-center justify-center text-white/10 text-xs hover:border-blue-500/50 transition-colors">
        ...
        <div class="relative bg-[#0F0F0F] border border-white/10 w-full max-w-md rounded-[3rem] p-10 shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div class="text-center">
                ...
                <p class="text-white/20 text-[10px] font-bold uppercase tracking-widest leading-relaxed">
                    The requested data stream is currently <span class="text-blue-500 font-black italic">Empty</span>. No records have been synthesized for this parameter yet.
                </p>
                <button onclick="closeTaskModal()" class="mt-8 w-full py-4 rounded-2xl bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 hover:scale-[1.02] transition-all shadow-lg shadow-blue-600/20">
                    Acknowledge
                </button>
            </div>
        </div>
