#!/bin/bash
# ============================================================
# T-Learn Pro Beta — Full Install Script
# Writes ALL refactored files directly into your project.
# Run from inside your T-learn-Pro-Beta/ root directory.
# Usage: bash install_refactor.sh
# ============================================================
...
echo ""
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}  T-LEARN PRO — Full Refactor Install${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
mkdir -p js/views
mkdir -p js/modules
echo -e "  ${GREEN}✓${NC} js/views/"
echo -e "  ${GREEN}✓${NC} js/modules/"

echo ""
echo -e "${YELLOW}[2/4] Backing up originals...${NC}"
[ -f "js/dashboard.js" ]       && cp js/dashboard.js js/dashboard.js.backup       && echo -e "  ${GREEN}✓${NC} dashboard.js.backup"
[ -f "js/Overview.js" ]        && cp js/Overview.js js/Overview.js.backup          && echo -e "  ${GREEN}✓${NC} Overview.js.backup"
[ -f "pages/dashboard.html" ]  && cp pages/dashboard.html pages/dashboard.html.backup && echo -e "  ${GREEN}✓${NC} dashboard.html.backup"

echo ""
echo -e "${YELLOW}[3/4] Writing refactored files...${NC}"


# ── CORE ──
cat > "js/dashboard.js" << 'TLPEOF_JS_DASHBOARD_JS'
...
function updateView(viewName) {
    ...
    setTimeout(() => {
        ...
        if (_viewCache[viewName]) {
            ...
            `;
            _viewCache[viewName] = container.innerHTML;
        }
        ...
        // Notifications can't be cached — always re-render (live data)
        if (viewName === 'Notifications') {
            delete _viewCache['Notifications'];
        }
...
TLPEOF_JS_DASHBOARD_JS
echo -e "  ${GREEN}✓${NC} js/dashboard.js"

# ── CHART LAZY INIT ──
cat > "js/Overview.js" << 'TLPEOF_JS_OVERVIEW_JS'
/**
...
TLPEOF_JS_OVERVIEW_JS
echo -e "  ${GREEN}✓${NC} js/Overview.js"

# ── CURRICULUM DATA ──
cat > "js/curriculum.js" << 'TLPEOF_JS_CURRICULUM_JS'
/**
...
TLPEOF_JS_CURRICULUM_JS
echo -e "  ${GREEN}✓${NC} js/curriculum.js"

# ── VIEW: Overview ──
cat > "js/views/overview.js" << 'TLPEOF_JS_VIEWS_OVERVIEW_JS'
...
TLPEOF_JS_VIEWS_OVERVIEW_JS
echo -e "  ${GREEN}✓${NC} js/views/overview.js"

# ── VIEW: Lessons ──
cat > "js/views/lessons.js" << 'TLPEOF_JS_VIEWS_LESSONS_JS'
...
TLPEOF_JS_VIEWS_LESSONS_JS
echo -e "  ${GREEN}✓${NC} js/views/lessons.js"

# ── VIEW: Projects ──
cat > "js/views/projects-view.js" << 'TLPEOF_JS_VIEWS_PROJECTS_VIEW_JS'
...
TLPEOF_JS_VIEWS_PROJECTS_VIEW_JS
echo -e "  ${GREEN}✓${NC} js/views/projects-view.js"

# ── VIEW: Leaderboard ──
cat > "js/views/leaderboard.js" << 'TLPEOF_JS_VIEWS_LEADERBOARD_JS'
...
TLPEOF_JS_VIEWS_LEADERBOARD_JS
echo -e "  ${GREEN}✓${NC} js/views/leaderboard.js"

# ── VIEW: Collaboration ──
cat > "js/views/collaboration.js" << 'TLPEOF_JS_VIEWS_COLLABORATION_JS'
...
TLPEOF_JS_VIEWS_COLLABORATION_JS
echo -e "  ${GREEN}✓${NC} js/views/collaboration.js"

# ── VIEW: Team ──
cat > "js/views/team.js" << 'TLPEOF_JS_VIEWS_TEAM_JS'
...
TLPEOF_JS_VIEWS_TEAM_JS
echo -e "  ${GREEN}✓${NC} js/views/team.js"

# ── VIEW: Inbox ──
cat > "js/views/inbox.js" << 'TLPEOF_JS_VIEWS_INBOX_JS'
...
TLPEOF_JS_VIEWS_INBOX_JS
echo -e "  ${GREEN}✓${NC} js/views/inbox.js"

# ── VIEW: Nxxt AI ──
cat > "js/views/nxxtai.js" << 'TLPEOF_JS_VIEWS_NXXTAI_JS'
...
TLPEOF_JS_VIEWS_NXXTAI_JS
echo -e "  ${GREEN}✓${NC} js/views/nxxtai.js"

# ── VIEW: Nxxt Lab ──
cat > "js/views/nxxtlab.js" << 'TLPEOF_JS_VIEWS_NXXTLAB_JS'
...
TLPEOF_JS_VIEWS_NXXTLAB_JS
echo -e "  ${GREEN}✓${NC} js/views/nxxtlab.js"

# ── VIEW: Side Hustle Hub ──
cat > "js/views/sidehustlehub.js" << 'TLPEOF_JS_VIEWS_SIDEHUSTLEHUB_JS'
...
TLPEOF_JS_VIEWS_SIDEHUSTLEHUB_JS
echo -e "  ${GREEN}✓${NC} js/views/sidehustlehub.js"

# ── VIEW: Notifications ──
cat > "js/views/notifications.js" << 'TLPEOF_JS_VIEWS_NOTIFICATIONS_JS'
...
TLPEOF_JS_VIEWS_NOTIFICATIONS_JS
echo -e "  ${GREEN}✓${NC} js/views/notifications.js"

# ── VIEW: Xt Pay ──
cat > "js/views/xtpay.js" << 'TLPEOF_JS_VIEWS_XTPAY_JS'
...
TLPEOF_JS_VIEWS_XTPAY_JS
echo -e "  ${GREEN}✓${NC} js/views/xtpay.js"

# ── VIEW: Pricing ──
cat > "js/views/pricing.js" << 'TLPEOF_JS_VIEWS_PRICING_JS'
...
TLPEOF_JS_VIEWS_PRICING_JS
echo -e "  ${GREEN}✓${NC} js/views/pricing.js"

# ── VIEW: Settings ──
cat > "js/views/settings.js" << 'TLPEOF_JS_VIEWS_SETTINGS_JS'
...
TLPEOF_JS_VIEWS_SETTINGS_JS
echo -e "  ${GREEN}✓${NC} js/views/settings.js"

# ── MODULE: ui ──
cat > "js/modules/ui.js" << 'TLPEOF_JS_MODULES_UI_JS'
...
TLPEOF_JS_MODULES_UI_JS
echo -e "  ${GREEN}✓${NC} js/modules/ui.js"

# ── MODULE: settings ──
cat > "js/modules/settings.js" << 'TLPEOF_JS_MODULES_SETTINGS_JS'
...
TLPEOF_JS_MODULES_SETTINGS_JS
echo -e "  ${GREEN}✓${NC} js/modules/settings.js"

# ── MODULE: lms ──
cat > "js/modules/lms.js" << 'TLPEOF_JS_MODULES_LMS_JS'
...
TLPEOF_JS_MODULES_LMS_JS
echo -e "  ${GREEN}✓${NC} js/modules/lms.js"

# ── MODULE: proj ──
cat > "js/modules/proj.js" << 'TLPEOF_JS_MODULES_PROJ_JS'
...
TLPEOF_JS_MODULES_PROJ_JS
echo -e "  ${GREEN}✓${NC} js/modules/proj.js"

# ── MODULE: nxxtai ──
cat > "js/modules/nxxtai.js" << 'TLPEOF_JS_MODULES_NXXTAI_JS'
...
TLPEOF_JS_MODULES_NXXTAI_JS
echo -e "  ${GREEN}✓${NC} js/modules/nxxtai.js"

# ── HTML: dashboard ──
cat > "pages/dashboard.html" << 'TLPEOF_PAGES_DASHBOARD_HTML'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
TLPEOF_PAGES_DASHBOARD_HTML
echo -e "  ${GREEN}✓${NC} pages/dashboard.html"

echo ""
echo -e "${YELLOW}[4/4] Verifying files...${NC}"
...
for f in "${FILES[@]}"; do
  if [ -f "$f" ] && [ -s "$f" ]; then
    ...
    echo -e "  ${RED}✗${NC} $f  — MISSING or EMPTY"
    ALL_OK=false
  fi
done
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
if [ "$ALL_OK" = true ]; then
  echo -e "${GREEN}  ✓ All 23 files installed successfully!${NC}"
  echo -e "${GREEN}  Originals saved as .backup files.${NC}"
  echo -e "${GREEN}  Open dashboard.html in your browser to test.${NC}"
else
  echo -e "${RED}  Some files failed — check the errors above.${NC}"
fi
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
